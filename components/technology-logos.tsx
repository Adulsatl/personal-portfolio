...
export const TechnologyLogos = () => {
  const technologies = [
    ...
    },
    {
      id: 'linux',
      name: 'Linux',
      icon: <Terminal className="w-12 h-12 text-orange-400" />,
    ...
    },
    {
      id: 'networks',
      name: 'Network Mgmt',
      icon: <Router className="w-12 h-12 text-green-400" />,
    ...
    },
    {
      ...
      icon: <HardDrive className="w-12 h-12 text-yellow-400" />,
    ...
    },
    {
      ...
      icon: <Zap className="w-12 h-12 text-lime-400" />,
    ...
    },
    {
      ...
      icon: <GitBranch className="w-12 h-12 text-pink-400" />,
